...
AKIAIBZEC6LIKGRNS3IQ	AKIAZT3CYNUKX4KIRVPV
AKIAIBZEC6LIKGRNS3IQ	AKIAZT3CYNUK6KZFR3JF
AKIAIBZEC6LIKGRNS3IQ	AKIAZT3CYNUKTWORP6LJ
...
def main():
    ...
    for i, row in df.iterrows():
        ...
        try:
            ...
            results.append({
                'old_key': old_key,
                'new_key': new_key,
                'old_last_used': json.dumps(response_old['AccessKeyLastUsed'], default=str),
                'new_last_used':  json.dumps(response_new['AccessKeyLastUsed'], default=str),
                'old_username': response_old['UserName'],
                'new_username': response_new['UserName']
            })
    ...
    df.to_excel('keys-last-used.xlsx', index=False)
