""" test boundary policy ann-ann02ads-ssm-parameter-manage-abac-policy """
...
POLICY_NAME_TO_TEST = "ann-ann02ads-ssm-parameter-manage-abac-policy"
...
class TestPolicySecretManager(unittest.TestCase):
    ...
    def test_put_parameters_good_tags(self):
