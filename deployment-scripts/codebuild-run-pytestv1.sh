...
unzip -o ./chromedriver_linux64.zip -d webdrivers/
export PATH="$PATH:`pwd`/webdrivers"
echo "Executing Pytest..."
cd ${SANITY_TEST_PATH}
python -m pytest tests_files/* -v -m ${MARKER} --junitxml="/tmp/reports/${REPORTS_FOLDER}/results.xml" 
echo ${MARKER} "Test Completed"